...
14. [Демо Fuzzy Drone Arena](14-Drone-Arena-Demo.md) — готовий приклад із дев’ятьма агентами.
15. [Архітектура та продуктивність](15-Architecture-And-Performance.md) — кешування, потоки й вартість обчислень.
16. [Поширені запитання](16-FAQ.md) — короткі відповіді на типові проблеми.
17. [Демонстраційний контент](17-Demo-Content.md) — карти, окремий модуль і виключення Demo зі збірки.
