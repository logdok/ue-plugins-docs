...
1. Copy `Plugins/QuestSystem` into your project's `Plugins/` folder.
2. Enable it: **Edit > Plugins > QuestSystem**.
3. That's it — no code required yet. `UQuestWorldSubsystem` automatically attaches a quest manager to every player and to the game state.
