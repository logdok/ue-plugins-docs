...
| `Core/ISItemFragment.h` | правило спільності фрагментів і всі 12 хуків |
...
| `InventorySystemTests/Private/Tests/ISRegressionTests.cpp` | гарантії, які найлегше зламати ненавмисно, з поясненням чому |
