...
|---|---|
| `AISLootContainer::Open` / `Close` | викликати з **серверного** боку вашої взаємодії |
| `AISItemPickup::SpawnForItem` | викидання предмета — Server RPC на гравцеві, що викидає |
| `UISInventoryComponent::TryAddItemInstance` | клієнт не може передати серверу вказівник на об'єкт; використовуйте `TryTransferFrom` або `TryCollect` |
