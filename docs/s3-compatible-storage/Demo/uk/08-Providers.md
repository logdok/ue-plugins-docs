...
провайдер реалізує самостійно.

## Що працює де

| Провайдер | Запис і зчитування | Багаточастинне + скасування | Копіювання | Підписані посилання | Теги | Правила життєвого циклу | Відновлення зчитування |
|---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| [Amazon S3](#amazon-s3) | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |
...
включно з тегами, правилами життєвого циклу й відновленням перерваного зчитування, де інші
провайдери так чи інакше спотикаються. Поводиться як звичайний S3 без винятків.
