...
> **На Amazon S3, MinIO, Cloudflare R2 і Wasabi це поле не обов'язкове** — знадобиться, лише
> якщо ви свідомо ввімкнули версіювання бакета. **На Backblaze B2 — інакше**: там сховище
